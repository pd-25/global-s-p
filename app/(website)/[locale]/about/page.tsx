...
const CartIcon = () => (
  ...
  >
    <path
      d="M3 3H5L5.4 5M5.4 5H21L19 14H7M5.4 5L7 14M7 14L5 16C4.44772 16.5523 4.83939 17.5 5.61803 17.5H19"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const FactoryIcon = () => (
  ...
  >
    <path
      d="M2 20H22M4 20V8L9 11V8L14 11V8L19 11V20"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
  ...
  return (
    <Box sx={{ bgcolor: "#F9FAF9", minHeight: "100vh", pb: 0 }}>
      ...
      >
        ...
        <Box
          sx={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle, rgba(127,175,13,0.15) 0%, rgba(1,75,53,0) 70%)",
            bottom: "-10%",
            right: "-5%",
            zIndex: 0,
          }}
          ...
          >
            {[
              ...
              <Grid
                ...
                key={i}
                sx={{ textAlign: "center", py: { xs: 2, md: 0 } }}
              >
                <Typography
                  sx={{
                    fontWeight: 800,
                ...
                <Typography
                  sx={{ fontSize: "14px", color: "#6B7280", fontWeight: 600 }}
                >
                  {stat.label}
                </Typography>
              </Grid>
      ...
      >
        <Grid container spacing={8} alignItems="center">
          <Grid size={{ xs: 12, md: 6 }}>
            ...
            <Typography
              sx={{ fontSize: "17px", lineHeight: 1.7, color: "#4B5563" }}
            >
              {t("mission.desc2")}
            </Typography>
          </Grid>
            ...
            <Stack spacing={4}>
              <Box sx={{ display: "flex", gap: 3 }}>
                ...
                <Box>
                  ...
                  >
                    {t("mission.feature1Title")}
                  </Typography>
                  <Typography sx={{ color: "#6B7280", lineHeight: 1.6 }}>
                    {t("mission.feature1Desc")}
                  </Typography>
                </Box>
              </Box>
              <Box sx={{ display: "flex", gap: 3 }}>
                ...
                <Box>
                  <Typography
                    ...
                    sx={{ fontWeight: 700, mb: 1, color: "#1F2937" }}
                  >
                    {t("mission.feature2Title")}
                  </Typography>
                  <Typography sx={{ color: "#6B7280", lineHeight: 1.6 }}>
                    {t("mission.feature2Desc")}
                  </Typography>
                </Box>
              </Box>
              <Box sx={{ display: "flex", gap: 3 }}>
                ...
                <Box>
                  <Typography
                    ...
                    sx={{ fontWeight: 700, mb: 1, color: "#1F2937" }}
                  >
                    {t("mission.feature3Title")}
                  </Typography>
                  <Typography sx={{ color: "#6B7280", lineHeight: 1.6 }}>
                    {t("mission.feature3Desc")}
                  </Typography>
                </Box>
              </Box>
            </Stack>
      ...
      <Box sx={{ bgcolor: "white", py: { xs: 10, md: 14 } }}>
        <Container
          disableGutters
          sx={{ maxWidth: "1250px !important", px: { xs: 2, lg: 0 } }}
        >
          <Grid
            container
            spacing={8}
      ...
      {/* CTA Section */}
      <Box
        sx={{ bgcolor: "#014B35", py: { xs: 8, md: 10 }, textAlign: "center" }}
      >
        <Container
          disableGutters
          sx={{ maxWidth: "1250px !important", px: { xs: 2, lg: 0 } }}
