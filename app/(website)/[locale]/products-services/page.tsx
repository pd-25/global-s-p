        ...
        <Container>
          <Box className="ps-hero__inner">
            ...
            <Typography className="ps-hero__sub">
              Browse our complete catalogue of product categories. Click any
              card to expand and explore its subcategories.
            </Typography>

            {/* ── CTA Button ───────────────────────────────────────── */}
            <NextLink
              href={routes.productListPage}
              className="ps-hero__cta-link"
            >
      ...
      >
        ...
        <Container maxWidth="lg" sx={{ position: "relative", zIndex: 1 }}>
          <Box sx={{ textAlign: "center", mb: 6 }}>
            ...
            >
              We're growing every day. Here are the numbers that define our
              platform's vast international selection.
            </Typography>
          </Box>
