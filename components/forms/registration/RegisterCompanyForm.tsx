...
export default function RegisterCompanyForm({
  ...
  const validateForm = () => {
    ...
    if (formData.website && !/^https?:\/\/.*/.test(formData.website)) {
      newErrors.website = t("validation.invalidWebsite", {
        defaultValue: "Start with http:// or https://",
      })
    }
    ...
    if (!formData.isAcceptTerms) {
      newErrors.isAcceptTerms = t("validation.acceptTerms", {
        defaultValue:
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (formData.address2)
        formDataObj.append("address_two", formData.address2)
      ...
      const response = await apiService.postFormData<{
        ...
        message: string
        data: any
      }>(websiteEndpoints.createSupplier, formDataObj)
      ...
      if (error.fieldErrors) {
        ...
        for (const [key, val] of Object.entries(error.fieldErrors)) {
          ...
          else if (key === "company_phone_number")
            newErrors.phone = val as string
  ...
  return (
    <Box sx={{ backgroundColor: "#F8FAFC", minHeight: "100vh", pb: 10 }}>
      ...
      >
        ...
        <Box
          sx={{
            ...
            height: 300,
            borderRadius: "50%",
            backgroundColor: "rgba(127, 175, 13, 0.15)",
            filter: "blur(40px)",
          }}
        />
        <Box
          sx={{
            ...
            height: 350,
            borderRadius: "50%",
            backgroundColor: "rgba(127, 175, 13, 0.1)",
            filter: "blur(50px)",
          }}
        />
      ...
      <Container
        maxWidth="md"
        sx={{ mt: { xs: -6, md: -10 }, position: "relative", zIndex: 2 }}
      >
        {submitSuccess ? (
          <Card
            sx={{
          ...
          >
            ...
            >
              {t("successTitle", {
                defaultValue: "Company Registered Successfully!",
              })}
            </Typography>
            <Typography
              sx={{
            ...
            >
              {t("successMessage", {
                defaultValue:
                  "Thank you for registering on our platform. Your company details have been submitted standard and are pending verification.",
              })}
            </Typography>
          </Card>
        ) : (
            ...
            >
              ...
              >
                <Avatar
                  sx={{
                    ...
                    width: 64,
                    height: 64,
                    boxShadow: "0 8px 16px rgba(127, 175, 13, 0.2)",
                  }}
                >
                  <StorefrontIcon fontSize="large" />
                </Avatar>
              ...
              <Grid container spacing={3}>
                ...
                <Grid size={{ xs: 12, md: 4 }}>
                  ...
                  >
                    ...
                    >
                      {formData.logo
                        ? formData.logo.name
                        : t("sections.companyInfo.fields.uploadLogo", {
                ...
                <Grid size={{ xs: 12, md: 6 }}>
                  ...
                  >
                    <InputLabel>
                      {t("sections.companyInfo.fields.country")}
                    </InputLabel>
                    <Select
                ...
                <Grid size={{ xs: 12 }}>
                  ...
                  >
                    <Typography
                      ...
                      color="#333"
                    >
                      {t("sections.companyInfo.fields.companyDocuments", {
                    ...
                    {formData.documents.length < 5 && (
                      ...
                      >
                        {t("sections.companyInfo.fields.addDocument", {
                  ...
                  {formData.documents.map((doc, index) => (
                    ...
                    >
                      <Grid size={{ xs: 12, md: 5 }}>
                        <TextField
                          fullWidth
                          label={t("sections.companyInfo.fields.documentName", {
                            defaultValue: "Document Name",
                          })}
                          placeholder={t(
                            "sections.companyInfo.placeholders.documentName",
                            { defaultValue: "e.g. Incorporation Certificate" },
                          )}
                          value={doc.name}
                          onChange={(e) =>
                      ...
                      <Grid size={{ xs: 12, md: 6 }}>
                        ...
                        >
                          ...
                          >
                            {doc.file
                              ? doc.file.name
                              : t("sections.companyInfo.fields.uploadFile", {
                                  defaultValue:
              ...
              <Grid container spacing={3}>
                ...
                <Grid size={{ xs: 12, md: 6 }}>
                  <TextField
                    ...
                    sx={inputStyles}
                    placeholder={t("sections.address.placeholders.address2", {
                      defaultValue: "Suite, Building, Floor (optional)",
                    })}
                  />
                </Grid>
                <Grid size={{ xs: 12, md: 6 }}>
              ...
              <Grid container spacing={3}>
                ...
                <Grid size={{ xs: 12, md: 6 }}>
                  <TextField
                    ...
                    placeholder={t("sections.contact.placeholders.website", {
                      defaultValue: "e.g. www.company.com",
                    })}
                ...
                <Grid size={{ xs: 12, sm: 4, md: 4 }}>
                  ...
                  >
                    <InputLabel>
                      {t("sections.contact.fields.countryCode")}
                    </InputLabel>
                    <Select
            ...
            >
              ...
              >
                ...
                <Box>
                  ...
                  <Typography
                    ...
                    sx={{ color: "#666", fontSize: "15px" }}
                  >
                    Help buyers understand your capabilities and operations
                    better.
                  </Typography>
                </Box>
              </Stack>
              ...
              <Grid container spacing={3}>
                <Grid size={{ xs: 12, md: 6 }}>
                  ...
                  >
                    <InputLabel>
                      {t("sections.business.fields.employees")}
                    </InputLabel>
                    <Select
                ...
                <Grid size={{ xs: 12, md: 6 }}>
                  ...
                  >
                    <InputLabel>
                      {t("sections.business.fields.deliveryArea")}
                    </InputLabel>
                    <Select
                    ...
                    {errors.deliveryArea && (
                      <FormHelperText>{errors.deliveryArea}</FormHelperText>
                    )}
                  </FormControl>
                </Grid>
                <Grid size={{ xs: 12 }}>
                  ...
                  >
                    <InputLabel>
                      {t("sections.business.fields.companyType")}
                    </InputLabel>
                    <Select
                ...
                <Grid size={{ xs: 12 }}>
                  ...
                  >
                    <InputLabel>
                      {t("sections.business.fields.businessSector")}
                    </InputLabel>
                    <Select
                    ...
                    >
                      ...
                      <MenuItem value="Apparel & Textiles">
                        Apparel & Textiles
                      </MenuItem>
                      ...
                      <MenuItem value="Health & Medical">
                        Health & Medical
                      </MenuItem>
                    </Select>
                    {errors.businessSector && (
                      <FormHelperText>{errors.businessSector}</FormHelperText>
                    )}
                  </FormControl>
                </Grid>
                <Grid size={{ xs: 12 }}>
                  <TextField
                    ...
                    multiline
                    rows={4}
                    label={t("sections.business.fields.details", {
                      defaultValue: "Product details",
                    })}
                    placeholder={t("sections.business.placeholders.details", {
                      defaultValue: "Enter product details...",
                    })}
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      onChange={(e) => {
                        setFormData({
                          ...formData,
                          isAcceptTerms: e.target.checked,
                        })
                  ...
                  label={
                    ...
                    >
                      ...
                      <Link
                        href={routes.termsAndConditionsPage}
                        style={{
                          color: "#014B35",
                          fontWeight: 600,
                          textDecoration: "none",
