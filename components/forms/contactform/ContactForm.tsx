        ...
        >
            ...
            <Stack spacing={3}>
                ...
                <FormControl fullWidth size="small">
                    ...
                    >
                        <MenuItem value="Get price / quote">Get price / quote</MenuItem>
                        <MenuItem value="Product details">Product details</MenuItem>
                        <MenuItem value="Shipping inquiry">Shipping inquiry</MenuItem>
                    </Select>
                </FormControl>
